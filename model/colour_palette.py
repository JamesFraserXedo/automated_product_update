...
class ColourPalette(BasePageObject):
    ...
    def update_colours(self, colours):
        ...
        for colour in colours:
            try:
                self.colour_select.deselect_all()
                self.colour_select.select_by_visible_text(colour)
    ...
    def update_colour_set(self, colour_set):
        ...
        try:
            self.colour_select.select_by_visible_text(colour_set)
